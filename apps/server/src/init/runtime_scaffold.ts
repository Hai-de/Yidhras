...
const DEATH_NOTE_WORLD_PACK_TEMPLATE_BASENAME = 'death_note.yaml';
const DEATH_NOTE_WORLD_PACK_README_TEMPLATE_BASENAME = 'death_note.README.md';
const DEATH_NOTE_WORLD_PACK_CHANGELOG_TEMPLATE_BASENAME = 'death_note.CHANGELOG.md';
...
const SEEDED_WORLD_PACK_TEMPLATE_BASENAMES = [
  ...
  DEATH_NOTE_WORLD_PACK_TEMPLATE_BASENAME,
  DEATH_NOTE_WORLD_PACK_README_TEMPLATE_BASENAME,
  DEATH_NOTE_WORLD_PACK_CHANGELOG_TEMPLATE_BASENAME
] as const;
