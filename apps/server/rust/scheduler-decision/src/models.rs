...
impl fmt::Display for SchedulerReason {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            SchedulerReason::PeriodicTick => write!(f, "periodic_tick"),
            SchedulerReason::BootstrapSeed => write!(f, "bootstrap_seed"),
            SchedulerReason::EventFollowup => write!(f, "event_followup"),
            SchedulerReason::RelationshipChangeFollowup => {
                write!(f, "relationship_change_followup")
            }
            SchedulerReason::SnrChangeFollowup => write!(f, "snr_change_followup"),
            SchedulerReason::OverlayChangeFollowup => write!(f, "overlay_change_followup"),
            SchedulerReason::MemoryChangeFollowup => write!(f, "memory_change_followup"),
        }
    }
}
