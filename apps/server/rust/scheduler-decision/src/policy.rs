use crate::models::{
    EventDrivenSchedulerReason, SchedulerKernelEvaluateInput, SchedulerReason,
...
pub fn should_suppress_for_recovery_window(
    ...
    let event_reason: EventDrivenSchedulerReason = match reason {
        ...
        SchedulerReason::OverlayChangeFollowup => EventDrivenSchedulerReason::OverlayChangeFollowup,
    ...
    policy.suppress_event_tiers.iter().any(|tier| tier == &signal_policy.suppression_tier)
}
