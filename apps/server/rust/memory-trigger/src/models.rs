...
pub struct MemoryRuntimeStateDto {
    ...
    #[serde(default)]
    pub last_triggered_tick: Option<Tick>,
    #[serde(default)]
    pub last_inserted_tick: Option<Tick>,
    #[serde(default)]
    pub cooldown_until_tick: Option<Tick>,
    #[serde(default)]
    pub delayed_until_tick: Option<Tick>,
    #[serde(default)]
    pub retain_until_tick: Option<Tick>,
